...
# Changed by:			Christophe Triomphe - 18/04/2018
# ChangeLog:
## Correction erreur de saisie sur les Items et filtres
...
result=$((get_TCP_socket_states; get_TCP_conn_stats) | /usr/bin/zabbix_sender -c /etc/zabbix/zabbix_agentd.conf -s $(hostname) -i - 2>&1)
